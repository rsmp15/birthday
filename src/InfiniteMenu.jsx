...
export default function InfiniteMenu({ items = [], scale = 1.0, backgroundColor = '#000000', onItemClick = null }) {
  ...
  return (
    ...
    >
      <div className="infinite-menu-hint">
        <span>✨</span> Drag or swipe 3D sphere to explore <span>✨</span>
      </div>
      ...
      {activeItem && (
        <>
          ...
          <div onClick={handleButtonClick} className={`action-button ${isMoving ? 'inactive' : 'active'}`} title="View Full Photo">
